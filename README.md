...
*In case you didn’t notice, I wrote this entire tale using only booleans.*
...
***Some ancient English theorists say yes.*** The strategy used to name these values shouts “true or false” from the rooftops.
